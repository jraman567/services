...
// RefValExtractor For SEV-SNP, the reference values must be in the CoRIM format
//
//	Stores the values triples in the database as-is.
...
func (o Extractor) TaExtractor(avk comid.KeyTriple) (*handler.Endorsement, error) {
	...
	// ToDo: test if the key is root key
